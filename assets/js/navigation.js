...
(function( $ ) {
	...
	function initNavigation( containerClass, naviClass ) {
		...
		(function() {
			...
			menuToggle.on( 'click.wellington_', function() {
		...
		(function() {
			...
			var dropdownToggle = $( '<button />', { 'class': 'dropdown-toggle', 'aria-expanded': false } )
				.append( wellingtonScreenReaderText.icon )
				.append( $( '<span />', { 'class': 'screen-reader-text', text: wellingtonScreenReaderText.expand } ) );
			...
			navigation.find( '.current-menu-ancestor > button' )
				...
				.text( wellingtonScreenReaderText.collapse );
			...
			navigation.find( '.dropdown-toggle' ).click( function( e ) {
				...
				screenReaderSpan.text( screenReaderSpan.text() === wellingtonScreenReaderText.expand ? wellingtonScreenReaderText.collapse : wellingtonScreenReaderText.expand );
			} );
		})();
		...
		(function() {
			...
			function toggleFocusClassTouchScreen() {
				if ( 'none' === $( '.menu-toggle' ).css( 'display' ) ) {
					...
					$( document.body ).on( 'touchstart.wellington_', function( e ) {
					...
					menuList.find( '.menu-item-has-children > a, .page_item_has_children > a' )
						.on( 'touchstart.wellington_', function( e ) {
					...
					menuList.find( '.menu-item-has-children > a, .page_item_has_children > a' ).unbind( 'touchstart.wellington_' );
				}
			}

			if ( 'ontouchstart' in window ) {
				$( window ).on( 'resize.wellington_', toggleFocusClassTouchScreen );
				toggleFocusClassTouchScreen();
			}

			menuList.find( 'a' ).on( 'focus.wellington_ blur.wellington_', function() {
