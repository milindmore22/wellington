 ...
 */
function delphine_theme_addons_setup() {

	// Add theme support for Delphine Pro plugin.
	add_theme_support( 'delphine-pro' );
	...
	add_theme_support( 'infinite-scroll', array(
		...
		'wrapper'        => false,
		'render'         => 'delphine_infinite_scroll_render',
		'posts_per_page' => 6,
	) );

}
add_action( 'after_setup_theme', 'delphine_theme_addons_setup' );


/**
 * Load custom stylesheets for theme addons
 */
function delphine_theme_addons_scripts() {
...
add_action( 'wp_enqueue_scripts', 'delphine_theme_addons_scripts' );


/**
 * Add custom image sizes for theme addons
 */
function delphine_theme_addons_image_sizes() {
...
add_action( 'after_setup_theme', 'delphine_theme_addons_image_sizes' );


/**
 * Custom render function for Infinite Scroll.
 */
function delphine_infinite_scroll_render() {
