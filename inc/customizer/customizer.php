...
function wellington_customize_preview_js() {
	wp_enqueue_script( 'wellington-customizer-preview', get_template_directory_uri() . '/assets/js/customizer.js', array( 'customize-preview' ), '20180609', true );
}
...
function wellington_customize_preview_css() {
	wp_enqueue_style( 'wellington-customizer-css', get_template_directory_uri() . '/assets/css/customizer.css', array(), '20180609' );
}
